...
public class Auth {
    ...
    public static Pair<String, String> authXSTS(String xblToken) throws AuthException, IllegalArgumentException, Exception {
        ...
        if (pr.response() == 401) throw new AuthException(Component.translatable("ias.msauth.error.noxbox"));
    ...
    public static void checkGameOwnership(String accessToken) throws AuthException, IllegalArgumentException, Exception {
        ...
        if (IAS.GSON.fromJson(pr.body(), JsonObject.class).getAsJsonArray("items").size() == 0) throw new AuthException(Component.translatable("ias.msauth.error.gamenotowned"));
    }
