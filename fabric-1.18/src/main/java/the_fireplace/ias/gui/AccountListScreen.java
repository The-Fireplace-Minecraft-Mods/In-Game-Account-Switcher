    ...
    private void login() {
        ...
        acc.login((s, o) -> state = I18n.get(s, o)).whenComplete((d, t) -> {
            ...
            minecraft.execute(() -> {
                ...
                UserApiService apiSvc = ((MinecraftAccessor) minecraft).ias$createUserApiService(new YggdrasilAuthenticationService(Proxy.NO_PROXY), new GameConfig(new GameConfig.UserData(minecraft.getUser(), null, null, null), null, null, null, null));
