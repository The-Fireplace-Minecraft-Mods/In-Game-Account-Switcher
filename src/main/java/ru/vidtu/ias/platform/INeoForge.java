...
public final class INeoForge {
    ...
    public INeoForge(Dist dist, ModContainer container, IEventBus bus) {
        ...
        //? if >=1.20.6 {
        container.registerExtensionPoint(net.neoforged.neoforge.client.gui.IConfigScreenFactory.class, (modOrGame, parent) -> new ConfigScreen(parent));
        //?} else {
        /^container.registerExtensionPoint(net.neoforged.neoforge.client.ConfigScreenHandler.ConfigScreenFactory.class, () -> new net.neoforged.neoforge.client.ConfigScreenHandler.ConfigScreenFactory((game, screen) -> new ConfigScreen(screen)));
