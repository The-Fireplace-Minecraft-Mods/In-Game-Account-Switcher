...
public class LoginScreen extends Screen {
    ...
    public LoginScreen(Screen prev, ITextComponent title, String buttonText, String buttonTip, Consumer<Account> handler) {
        super(title);
        this.prev = prev;
    ...
    public void init() {
        ...
        username = addButton(new TextFieldWidget(font, this.width / 2 - 100, height / 2 - 12, 200, 20, username, I18n.get("ias.loginGui.nickname")));
