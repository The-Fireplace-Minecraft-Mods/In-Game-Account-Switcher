...
public class IASConfigScreen extends Screen {
    ...
    public void init() {
        ...
        addButton(titleScreenText = new CheckboxButton(5, 20, 24 + font.width(I18n.get(
                "ias.configGui.titleScreenText")), 20, I18n.get(
                        "ias.configGui.titleScreenText"), Config.titleScreenText));
        addButton(titleScreenTextX = new TextFieldWidget(font, 35 + font.width(I18n.get(
                "ias.configGui.titleScreenText")), 20, 50, 20, "X"));
        addButton(titleScreenTextY = new TextFieldWidget(font, 35 + font.width(I18n.get(
        ...
        addButton(titleScreenTextAlignment = new Button(35 + font.width(I18n.get(
                ...
                btn -> changeAlignment()));
        addButton(titleScreenButton = new CheckboxButton(5, 44, 24 + font.width(I18n.get(
                "ias.configGui.titleScreenButton")), 20, I18n.get(
                "ias.configGui.titleScreenButton"), Config.titleScreenButton));
        addButton(titleScreenButtonX = new TextFieldWidget(font, 35 + font.width(I18n.get(
                "ias.configGui.titleScreenButton")), 44, 50, 20, "X"));
        addButton(titleScreenButtonY = new TextFieldWidget(font, 35 + font.width(I18n.get(
                "ias.configGui.titleScreenButton")) + 54, 44, 50, 20, "Y"));
        addButton(multiplayerScreenButton = new CheckboxButton(5, 68, 24 + font.width(I18n.get(
                "ias.configGui.multiplayerScreenButton")), 20, I18n.get(
                "ias.configGui.multiplayerScreenButton"), Config.multiplayerScreenButton));
        addButton(multiplayerScreenButtonX = new TextFieldWidget(font, 35 + font.width(I18n.get(
                "ias.configGui.multiplayerScreenButton")), 68, 50, 20, "X"));
        addButton(multiplayerScreenButtonY = new TextFieldWidget(font, 35 + font.width(I18n.get(
