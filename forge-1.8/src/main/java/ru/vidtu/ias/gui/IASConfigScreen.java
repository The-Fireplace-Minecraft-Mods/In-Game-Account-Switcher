...
public class IASConfigScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        titleScreenTextX = new GuiTextField(2, fontRendererObj, 35 + fontRendererObj.getStringWidth(I18n.format(
                "ias.configGui.titleScreenText")), 20, 50, 20);
        titleScreenTextY = new GuiTextField(3, fontRendererObj, 35 + fontRendererObj.getStringWidth(I18n.format(
        ...
        titleScreenButtonX = new GuiTextField(6, fontRendererObj, 35 + fontRendererObj.getStringWidth(I18n.format(
                "ias.configGui.titleScreenButton")), 44, 50, 20);
        titleScreenButtonY = new GuiTextField(7, fontRendererObj, 35 + fontRendererObj.getStringWidth(I18n.format(
        ...
        multiplayerScreenButtonX = new GuiTextField(9, fontRendererObj, 35 + fontRendererObj.getStringWidth(I18n.format(
                "ias.configGui.multiplayerScreenButton")), 68, 50, 20);
        multiplayerScreenButtonY = new GuiTextField(10, fontRendererObj, 35 + fontRendererObj.getStringWidth(I18n.format(
    ...
    private void changeAlignment() {
        ...
        titleScreenTextAlignment.setWidth(fontRendererObj.getStringWidth(titleScreenTextAlignment.displayString) + 20);
    }
