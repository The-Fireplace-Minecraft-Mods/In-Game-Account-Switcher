...
public class AccountListScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        search = new GuiTextField(1, this.fontRendererObj, this.width / 2 - 80, 14, 160, 16);
        ...
        updateButtons();
        search.func_175207_a(new GuiPageButtonList.GuiResponder() { // setGuiResponder
            @Override
            public void func_175321_a(int id, boolean value) {} // setBooleanValue
            @Override
            public void onTick(int id, float value) {} // setFloatValue
            @Override
            public void func_175319_a(int id, String value) { // setStringValue
    ...
    public void mouseClicked(int mx, int my, int btn) throws IOException {
        if (list.mouseClicked(mx, my, btn)) return;
