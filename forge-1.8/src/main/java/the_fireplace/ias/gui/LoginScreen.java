...
public class LoginScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        username = new GuiTextField(2, fontRendererObj, this.width / 2 - 100, height / 2 - 12, 200, 20);
    ...
    public void drawScreen(int mx, int my, float delta) {
        ...
        if (offline.isMouseOver()) {
            drawHoveringText(fontRendererObj.listFormattedStringToWidth(buttonTip, 150), mx, my);
        }
    }
