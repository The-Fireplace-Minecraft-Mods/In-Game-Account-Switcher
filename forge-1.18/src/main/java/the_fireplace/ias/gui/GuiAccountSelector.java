...
public class GuiAccountSelector extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(reloadskins = new Button(2, 2, 120, 20, new TranslatableComponent("ias.reloadskins"), btn -> reloadSkins()));
        addRenderableWidget(new Button(this.width / 2 + 4 + 40, this.height - 52, 120, 20, new TranslatableComponent("ias.addaccount"), btn -> add()));
        addRenderableWidget(login = new Button(this.width / 2 - 154 - 10, this.height - 52, 120, 20, new TranslatableComponent("ias.login"), btn -> accountsgui.login()));
        addRenderableWidget(edit = new Button(this.width / 2 - 40, this.height - 52, 80, 20, new TranslatableComponent("ias.edit"), btn -> accountsgui.edit()));
        addRenderableWidget(loginoffline = new Button(this.width / 2 - 154 - 10, this.height - 28, 110, 20, new TranslatableComponent("ias.login").append(" ").append(new TranslatableComponent("ias.offline")), btn -> accountsgui.loginOffline()));
        addRenderableWidget(new Button(this.width / 2 + 4 + 50, this.height - 28, 110, 20, new TranslatableComponent("gui.cancel"), btn -> minecraft.setScreen(prev)));
        addRenderableWidget(delete = new Button(this.width / 2 - 50, this.height - 28, 100, 20, new TranslatableComponent("ias.delete"), btn -> accountsgui.delete()));
    ...
    public class AccountEntry extends ObjectSelectionList.Entry<AccountEntry> {
        ...
        public Component getNarration() {
            return new TextComponent(account.alias());
        }
    }
}
