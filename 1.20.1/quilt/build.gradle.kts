...
group = "ru.vidtu.ias"
base.archivesName = "IAS-Quilt-1.20.1"
...
dependencies {
    ...
    modImplementation("org.quiltmc.quilted-fabric-api:quilted-fabric-api:7.6.0+0.92.2-1.20.1")
...
tasks.withType<Jar> {
    ...
    manifest {
        attributes(
            ...
            "Implementation-Title" to "IAS-Quilt-1.20.1",
