...
public class AbstractAccountGui extends Screen {
    ...
    public void init() {
        ...
        username = addButton(new TextFieldWidget(font, this.width / 2 - 100, 60, 200, 20, new TranslationTextComponent("ias.username")));
        username.setMaxLength(512);
        password = addButton(new GuiPasswordField(font, this.width / 2 - 100, 90, 200, 20, new TranslationTextComponent("ias.password")));
