...
group = "ru.vidtu.ias"
base.archivesName = "IAS-NeoForge-1.21.1"
...
evaluationDependsOn(":legacy_1.21.1-root")
val shared = project(":legacy_1.21.1-root")
...
tasks.withType<Jar> {
    ...
    manifest {
        attributes(
            ...
            "Implementation-Title" to "IAS-NeoForge-1.21.1",
