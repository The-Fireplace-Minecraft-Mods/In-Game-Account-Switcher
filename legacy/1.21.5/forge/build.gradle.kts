...
group = "ru.vidtu.ias"
base.archivesName = "IAS-Forge-1.21.5"
...
evaluationDependsOn(":legacy_1.21.5-root")
val shared = project(":legacy_1.21.5-root")
...
tasks.withType<Jar> {
    ...
    manifest {
        attributes(
            ...
            "Implementation-Title" to "IAS-Forge-1.21.5",
