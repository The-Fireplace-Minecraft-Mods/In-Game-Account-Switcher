...
group = "ru.vidtu.ias"
base.archivesName = "IAS-Fabric-1.21.8"
...
evaluationDependsOn(":legacy_1.21.8-root")
val shared = project(":legacy_1.21.8-root")
...
dependencies {
    ...
    // Minecraft (Provided)
    minecraft(libs.minecraft.mc1218)
    mappings(loom.officialMojangMappings())

    // Fabric
    modImplementation(libs.fabric.loader)
    modImplementation(libs.fabric.mc1218)
    modImplementation(libs.modmenu.mc1218)
...
tasks.withType<Jar> {
    ...
    manifest {
        attributes(
            ...
            "Implementation-Title" to "IAS-Fabric-1.21.8",
