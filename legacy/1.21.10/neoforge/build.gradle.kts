...
group = "ru.vidtu.ias"
base.archivesName = "IAS-NeoForge-1.21.10"
...
evaluationDependsOn(":legacy_1.21.10-root")
val shared = project(":legacy_1.21.10-root")
...
dependencies {
    ...
    // NeoForge
    neoForge(libs.neoforge.mc12110)
...
tasks.withType<Jar> {
    ...
    manifest {
        attributes(
            ...
            "Implementation-Title" to "IAS-NeoForge-1.21.10",
