...
public class GuiAccountSelector extends Screen {
    ...
    protected void init() {
        ...
        addButton(loginoffline = new Button(this.width / 2 - 154 - 10, this.height - 28, 110, 20, new TranslatableComponent("ias.login").append(" ").append(new TranslatableComponent("ias.offline")).getColoredString(), btn -> accountsgui.loginOffline()));
        ...
        addButton(search = new EditBox(this.font, this.width / 2 - 80, 14, 160, 16, I18n.get("ias.search")));
        updateButtons();
