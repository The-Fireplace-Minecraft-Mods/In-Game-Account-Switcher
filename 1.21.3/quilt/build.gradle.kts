...
dependencies {
    ...
    modImplementation(libs.fabric.mc1213) // Quilt is dead.
...
tasks.withType<Jar> {
    ...
    manifest {
        attributes(
            ...
            "Implementation-Title" to "IAS-Quilt-1.21.3",
