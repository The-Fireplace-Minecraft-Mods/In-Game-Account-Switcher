...
public class IAS implements ClientModInitializer {
    public static final WidgetSprites IAS_BUTTON = new WidgetSprites(new ResourceLocation("ias", "iasbutton_plain"), new ResourceLocation("ias", "iasbutton_hover"));
    public static final Map<UUID, PlayerSkin> SKIN_CACHE = new HashMap<>();
    ...
    public void onInitializeClient() {
        ...
        ScreenEvents.AFTER_INIT.register((mc, screen, w, h) -> {
            ...
            if (screen instanceof JoinMultiplayerScreen && Config.multiplayerScreenButton) {
                ...
                temp = new ImageButton(bx, by, 20, 20, IAS_BUTTON,
