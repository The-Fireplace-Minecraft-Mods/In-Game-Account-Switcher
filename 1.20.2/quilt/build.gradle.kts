...
group = "ru.vidtu.ias"
base.archivesName = "IAS-Quilt-1.20.2"
...
dependencies {
    ...
    modImplementation("org.quiltmc.quilted-fabric-api:quilted-fabric-api:8.0.0-alpha.6+0.91.6-1.20.2")
...
tasks.withType<Jar> {
    ...
    manifest {
        attributes(
            ...
            "Implementation-Title" to "IAS-Quilt-1.20.2",
