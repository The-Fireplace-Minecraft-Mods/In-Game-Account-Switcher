...
public class LoginScreen extends Screen {
    ...
    public void init() {
        ...
        addButton(new Button(this.width / 2 + 2, this.height - 28, 150, 20, CommonComponents.GUI_CANCEL, btn -> minecraft.setScreen(prev)));
        username = addButton(new EditBox(font, this.width / 2 - 100, height / 2 - 12, 200, 20, username, new TranslatableComponent("ias.loginGui.nickname")));
        username.setMaxLength(16);
        addButton(microsoft = new Button(this.width / 2 - 50, this.height / 2 + 12, 100, 20, new TranslatableComponent("ias.loginGui.microsoft"), btn -> loginMicrosoft()));
    }
