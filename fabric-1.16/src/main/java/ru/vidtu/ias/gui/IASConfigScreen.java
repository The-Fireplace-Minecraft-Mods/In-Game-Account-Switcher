...
public class IASConfigScreen extends Screen {
    ...
    @Override
    public void init() {
        addButton(new Button(width / 2 - 75, height - 28, 150, 20, CommonComponents.GUI_DONE, button -> minecraft.setScreen(prev)));
        addButton(titleScreenText = new Checkbox(5, 20, 24 + font.width(new TranslatableComponent(
                "ias.configGui.titleScreenText")), 20, new TranslatableComponent(
                        "ias.configGui.titleScreenText"), Config.titleScreenText));
        addButton(titleScreenTextX = new EditBox(font, 35 + font.width(new TranslatableComponent(
                "ias.configGui.titleScreenText")), 20, 50, 20, new TextComponent("X")));
        addButton(titleScreenTextY = new EditBox(font, 35 + font.width(new TranslatableComponent(
                "ias.configGui.titleScreenText")) + 54, 20, 50, 20, new TextComponent("Y")));
        addButton(titleScreenTextAlignment = new Button(35 + font.width(new TranslatableComponent(
                ...
                btn -> changeAlignment()));
        addButton(titleScreenButton = new Checkbox(5, 44, 24 + font.width(new TranslatableComponent(
                "ias.configGui.titleScreenButton")), 20, new TranslatableComponent(
                "ias.configGui.titleScreenButton"), Config.titleScreenButton));
        addButton(titleScreenButtonX = new EditBox(font, 35 + font.width(new TranslatableComponent(
                "ias.configGui.titleScreenButton")), 44, 50, 20, new TextComponent("X")));
        addButton(titleScreenButtonY = new EditBox(font, 35 + font.width(new TranslatableComponent(
                "ias.configGui.titleScreenButton")) + 54, 44, 50, 20, new TextComponent("Y")));
        addButton(multiplayerScreenButton = new Checkbox(5, 68, 24 + font.width(new TranslatableComponent(
        ...
        addButton(multiplayerScreenButtonX = new EditBox(font, 35 + font.width(new TranslatableComponent(
                "ias.configGui.multiplayerScreenButton")), 68, 50, 20, new TextComponent("X")));
        addButton(multiplayerScreenButtonY = new EditBox(font, 35 + font.width(new TranslatableComponent(
